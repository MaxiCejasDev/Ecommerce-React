        ...
        <div className="p-[40px]">
            <div className="py-3 w-full flex items-center">
                <Link to={'/allcategory'} className="flex">
                    <img className="h-[20px] w-[20px]" src="https://drive.google.com/uc?export=download&id=1MB6ynCf84LHjLzG5qvQlFxXIagLl17CW" alt="" />
            ...
            <div onClick={handleScreenMenu} className="py-4 w-full flex items-center relative cursor-pointer">
                <div className="flex grow">
                    <img className="h-[20px] w-[20px]" src="https://drive.google.com/uc?export=download&id=1SuORGAZQ5d0viq3Q8Fkt2jYq7KKU5ATu" alt="" />
                    <p className="text-white font-poppins text-sm ml-2">Accesorios</p>
                </div>
                <img className={screenMenu?"h-[24px] w-[24px] absolute duration-[0.25s] right-0 rotate-0":"h-[24px] duration-[0.25s] w-[24px] absolute right-0 rotate-90"} src="https://drive.google.com/uc?export=download&id=1ZGLyQsRLKgUvdNP17MjI78Q-SV9ABvEN" alt="" />
                {screenMenu && <ScreenMenu/>}
            </div>
            <div onClick={handleAccesoryMenu} className="py-4 w-full flex items-center relative cursor-pointer">
                <div className="flex grow">
                    <img className="h-[20px] w-[20px]" src="https://drive.google.com/uc?export=download&id=1MwLciBusePiLwX6HGfXPwtnWxfeEfLPC" alt="" />
                    <p className="text-white font-poppins text-sm ml-2">Pantallas</p>
                </div>
                <img className={accesoryMenu?"h-[24px] w-[24px] absolute duration-[0.25s] right-0 rotate-0":"h-[24px] duration-[0.25s] w-[24px] absolute right-0 rotate-90"} src="https://drive.google.com/uc?export=download&id=1ZGLyQsRLKgUvdNP17MjI78Q-SV9ABvEN" alt="" />
