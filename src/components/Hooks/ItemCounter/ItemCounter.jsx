...
export const ItemCounter = ({productStock,handleAddBag,purchase}) => {
  ...
  return (
    <div className="flex justify-center items-center flex-col">
        ...
        {purchase?(<Link to={'/bag'} className="font-bold flex justify-center items-cemter rounded-[12px] items-center bg-green-600 w-[80%] sm:w-[300px] h-[60px] text-white shadow-md shadow-neutral-400 text-[12px] sm:text-sm md:text-base">Ver productos en bolsa
        
        </Link>):
        (<button onClick={()=>handleAddBag(counter)} className="font-bold flex justify-center rounded-[8px] mt-2 hover:bg-white hover:text-black hover:border-[1px] hover:border-black button-hover  items-center bg-black w-[80%] text-white shadow-md shadow-neutral-400 sm:w-[300px] h-[60px] text-[12px] sm:text-sm md:text-base">
            Agregar Producto
