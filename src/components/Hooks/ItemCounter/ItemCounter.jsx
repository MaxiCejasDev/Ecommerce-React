...
export const ItemCounter = ({productStock,handleAddBag,purchase}) => {
  ...
  return (
    <div className="flex justify-center items-center flex-col">
        ...
        (<button onClick={()=>handleAddBag(counter)} className="font-bold flex justify-center rounded-[12px] hover:bg-white hover:text-black hover:border-[1px] hover:border-black button-hover  items-center bg-black w-[80%] text-white shadow-md shadow-neutral-400 sm:w-[300px] h-[60px] text-[12px] sm:text-sm md:text-base">
            Agregar Producto
