...
export const About = () => {
  return (
    <>
      ...
      <div className=" w-full flex font-poppins text-whitelight bg-darkpure flex-col-reverse h-content min-h-[calc(100vh-60px)] lg:flex-row">
        <div className=" h-full md:w-full lg:w-2/4">
          ...
          <div className="h-3/4 grid lg:grid-cols-2 lg:grid-rows-2 gap-x-2 px-2 gap-y-4 2xl:px-36">
            <div className="flex items-center justify-center xl:place-self-end xl:justify-self-center">
              <div className="flex flex-col justify-center items-center h-[200px] w-[300px] overflow-hidden bg-darklight rounded-3xl">
        ...
        <div className="h-full flex flex-col items-center pt-8 md:w-full lg:w-2/4">
           ...
           <div className="pb-20">
           <Link to={'/allcategory'} className="text-black bg-whitelight hover:bg-neutral-200 py-8 rounded-3xl font-bold text-base px-20 lg:px-36">Ver Productos</Link>
           </div>
