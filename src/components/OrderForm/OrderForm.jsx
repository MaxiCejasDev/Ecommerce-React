...
export const OrderForm = ({notCompleteForm,orderData,order,formBlurFunctions,handleForm}) => {
  ...
  <form onSubmit={order} className="h-full w-full flex flex-col px-4 gap-y-6 py-10" action="">
    ...
    <div className="flex gap-x-2 relative">
      <input onChange={handleForm} onBlur={handleNameBlur} autoComplete="off" name="name" className="w-full pl-2 py-4 rounded-[8px] border-[1px] border-darklight bg-transparent outline-2 outline-[#0EA5E9]" type="text" placeholder="Nombre"/>
      {formError.nameHasError && <p className="text-red-600 text-xs top-full left-2 absolute">Ingrese su nombre</p>}
      <input onChange={handleForm} onBlur={handleLastnameBlur} autoComplete="off" name="lastname" className="w-full pl-2 py-4 rounded-[8px] border-[1px] border-darklight bg-transparent outline-2 outline-[#0EA5E9]" type="text" placeholder="Apellido"/>
    ...
    <div className="relative">
      <input onChange={handleForm} onBlur={handleEmailBlur} autoComplete="off" name="email" className="w-full pl-2 py-4 rounded-[8px] border-[1px] border-darklight bg-transparent outline-2 outline-[#0EA5E9]" type="text" placeholder="Correo electronico" />
    ...
    <div className="flex gap-x-2 relative">
      <div className="w-[80px] flex rounded-[8px] justify-center items-center border-[1px] text-base font-light border-darklight bg-neutral-800 text-white py-4"><p>+54</p></div>
      <input onChange={handleForm} onBlur={handlePhoneBlur} autoComplete="off" name="phone" className="py-4 pl-2 rounded-[8px] w-full border-[1px] border-darklight bg-transparent outline-2 outline-[#0EA5E9]" type="text" placeholder="Número de telefono"/>
      {formError.phoneHasError && <p className="text-red-600 text-xs top-full left-2 absolute">Ingrese valores numericos</p>}
    </div>
    <div className="relative">
      <input onChange={handleForm} onBlur={handleAddressBlur} autoComplete="off" name="address" className="w-full pl-2 py-4 rounded-[8px] border-[1px] border-darklight bg-transparent outline-2 outline-[#0EA5E9]" type="text" placeholder="Dirección de domicilio" />
