        ...
        <div className="sm:text-white flex flex-col md:pl-[80px] md:items-start justify-center items-center h-full">
            ...
            <div className="flex mb-[10px] flex-col justify-center items-center lg:flex-row lg:justify-start lg:items-end mt-10 md:mt-0">
                ...
                md:rounded-none rounded-md md:border-none border-2 border-black">
                    <img className="md:h-[20px] md:w-[20px] lg:h-[24px] lg:mr-[10px] md:block hidden" src="https://drive.google.com/uc?export=download&id=1Sp0pxjJ5vRQOazwDgUq7-pzUA9z6evcx" alt="" />
                    ...
                    <img className="md:hidden black-img w-[24px] h-[24px] ml-2" src="https://drive.google.com/uc?export=download&id=1Rm-2jrgy930Ekdp1vBjqSOs9AaEt0qr5" alt="" />
                </Link>
                ...
                md:rounded-none rounded-md md:border-none border-2 border-black">
                    <img className="md:h-[20px] md:w-[20px] lg:h-[24px] lg:mr-[10px] md:block hidden" src="https://drive.google.com/uc?export=download&id=1FenN8fkbCRUHOwOeOQXL6Fpk4mrRtLEm" alt="" />
                    ...
                    <img className="md:hidden black-img w-[24px] h-[24px] ml-2" src="https://drive.google.com/uc?export=download&id=1FenN8fkbCRUHOwOeOQXL6Fpk4mrRtLEm" alt="" />
                </Link>
            </div>
        </div>
        <div className="md:flex md:justify-center md:items-center hidden">
            <figure className="relative">
                <img className="md:h-[180px] md:w-[160px] lg:h-[200px] lg:w-[180px] xl:h-[270px] xl:w-[250px] border-[1px] border-white" src="https://drive.google.com/uc?export=download&id=1omMFR5qQzYBKZIjwkObxvN-IRHmtXEzn" alt="" />
                <img className="md:h-[180px] md:w-[160px] lg:h-[200px] lg:w-[180px] xl:h-[270px] xl:w-[250px] absolute top-[140px] right-[125px] z-10 border-[1px] border-white" src="https://drive.google.com/uc?export=download&id=1omMFR5qQzYBKZIjwkObxvN-IRHmtXEzn" alt="" />
            </figure>
        </div>
    </div>
    </>
